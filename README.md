...
Install/download counts are stored in [`stats.json`](stats.json) on the **`stats`** branch (that branch contains only this file; updated by GitHub Actions; `main` is PR-only).
